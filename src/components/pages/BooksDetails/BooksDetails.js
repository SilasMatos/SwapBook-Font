    ...
    return (
        <>
            ...
            {searchProducts ? (
                ...
                <div>
                    <div className="flex flex-col items-center justify-center h-screen bg-gray-200 my-1 ">
                            ...
                            <div className="flex flex-col sm:flex-row">
                                ...
                                <div className="sm:w-2/3 sm:pl-6 mt-4 sm:mt-0">
                                    ...
                                    <p className="text-gray-800 text-lg tx-sin font-medium mb-4">
                                       <span id='edit-sin-tx'>Sinopse:</span><br/> {response.synopsis}
                                    </p>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-2xl font-bold">
                                            <h6>
                                                Estado do Livro: {response.state}
                                            </h6>
                                        </div>
                                        <div className="text-2xl font-bold">
                                            <h6>
